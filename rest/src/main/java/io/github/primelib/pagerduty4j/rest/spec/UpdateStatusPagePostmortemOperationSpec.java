...
/**
 * UpdateStatusPagePostmortemSpec
 * <p>
 * Specification for the UpdateStatusPagePostmortem operation.
 * <p>
...
public class UpdateStatusPagePostmortemOperationSpec {
    /**
     ...
     */
    @Nullable 
    private UpdateStatusPagePostmortemRequest updateStatusPagePostmortemRequest;

    /**
     * Constructs a validated instance of {@link UpdateStatusPagePostmortemOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public UpdateStatusPagePostmortemOperationSpec(Consumer<UpdateStatusPagePostmortemOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param updateStatusPagePostmortemRequest 
     */
    @ApiStatus.Internal
    public UpdateStatusPagePostmortemOperationSpec(String id, String postId, String X_EARLY_ACCESS, UpdateStatusPagePostmortemRequest updateStatusPagePostmortemRequest) {
        this.id = id;
        this.postId = postId;
        this.X_EARLY_ACCESS = X_EARLY_ACCESS;
        this.updateStatusPagePostmortemRequest = updateStatusPagePostmortemRequest;
