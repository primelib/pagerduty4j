...
/**
 * DeleteStatusPagePostmortemSpec
 * <p>
 * Specification for the DeleteStatusPagePostmortem operation.
 * <p>
...
public class DeleteStatusPagePostmortemOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link DeleteStatusPagePostmortemOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public DeleteStatusPagePostmortemOperationSpec(Consumer<DeleteStatusPagePostmortemOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public DeleteStatusPagePostmortemOperationSpec(String id, String postId, String X_EARLY_ACCESS) {
        this.id = id;
        this.postId = postId;
