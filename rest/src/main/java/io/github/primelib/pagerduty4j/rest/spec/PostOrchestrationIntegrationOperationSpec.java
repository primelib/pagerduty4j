...
public class PostOrchestrationIntegrationOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link PostOrchestrationIntegrationOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public PostOrchestrationIntegrationOperationSpec(String id, PostOrchestrationIntegrationRequest postOrchestrationIntegrationRequest) {
        this.id = id;
