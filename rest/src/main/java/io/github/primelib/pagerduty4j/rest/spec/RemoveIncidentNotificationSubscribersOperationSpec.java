...
public class RemoveIncidentNotificationSubscribersOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link RemoveIncidentNotificationSubscribersOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public RemoveIncidentNotificationSubscribersOperationSpec(String id, CreateBusinessServiceNotificationSubscribersRequest createBusinessServiceNotificationSubscribersRequest) {
        this.id = id;
