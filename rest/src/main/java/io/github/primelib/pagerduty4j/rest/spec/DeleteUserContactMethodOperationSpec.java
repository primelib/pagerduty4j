...
public class DeleteUserContactMethodOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link DeleteUserContactMethodOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public DeleteUserContactMethodOperationSpec(Consumer<DeleteUserContactMethodOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public DeleteUserContactMethodOperationSpec(String id, String contactMethodId) {
        this.id = id;
