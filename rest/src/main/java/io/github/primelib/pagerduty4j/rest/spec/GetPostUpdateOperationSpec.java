 ...
 * GetPostUpdateSpec
 * <p>
 * Specification for the GetPostUpdate operation.
 * <p>
...
public class GetPostUpdateOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetPostUpdateOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetPostUpdateOperationSpec(Consumer<GetPostUpdateOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetPostUpdateOperationSpec(String id, String postId, String postUpdateId, String X_EARLY_ACCESS) {
        this.id = id;
        this.postId = postId;
