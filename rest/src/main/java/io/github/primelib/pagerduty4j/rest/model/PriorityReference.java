...
@JsonTypeName("PriorityReference")
...
public class PriorityReference {
     ...
     */
    public PriorityReference(Consumer<PriorityReference> spec) {
        spec.accept(this);
    }
     ...
     */
    @ApiStatus.Internal
    public PriorityReference(String id, String summary, TypeEnum type, String self, String htmlUrl) {
        this.id = id;
