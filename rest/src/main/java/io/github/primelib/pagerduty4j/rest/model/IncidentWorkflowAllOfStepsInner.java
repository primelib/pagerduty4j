...
public class IncidentWorkflowAllOfStepsInner {
    ...
    /**
     * Constructs a validated instance of {@link IncidentWorkflowAllOfStepsInner}.
     *
     ...
     * Constructs a validated instance of {@link IncidentWorkflowAllOfStepsInner}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #IncidentWorkflowAllOfStepsInner(Consumer)} instead.
     * @param id var.name
     ...
     * @param actionConfiguration var.name
     */
    @ApiStatus.Internal
    public IncidentWorkflowAllOfStepsInner(String id, String summary, TypeEnum type, String self, String htmlUrl, String name, String description, IncidentWorkflowAllOfStepsInnerAllOfActionConfiguration actionConfiguration) {
        this.id = id;
