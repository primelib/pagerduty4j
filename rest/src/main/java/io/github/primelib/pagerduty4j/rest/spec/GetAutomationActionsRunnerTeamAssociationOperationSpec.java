...
public class GetAutomationActionsRunnerTeamAssociationOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetAutomationActionsRunnerTeamAssociationOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public GetAutomationActionsRunnerTeamAssociationOperationSpec(String id, String teamId) {
        this.id = id;
        this.teamId = teamId;
