...
public class UpdateTeamEscalationPolicyOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link UpdateTeamEscalationPolicyOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public UpdateTeamEscalationPolicyOperationSpec(String id, String escalationPolicyId) {
        this.id = id;
