 ...
 * ListPrioritiesSpec
 * <p>
 * Specification for the ListPriorities operation.
 * <p>
 * List priorities
 */
@Getter
...
public class ListPrioritiesOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListPrioritiesOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListPrioritiesOperationSpec(Consumer<ListPrioritiesOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListPrioritiesOperationSpec(Integer limit, Integer offset, Boolean total) {
        this.limit = limit;
        this.offset = offset;
        this.total = total;
