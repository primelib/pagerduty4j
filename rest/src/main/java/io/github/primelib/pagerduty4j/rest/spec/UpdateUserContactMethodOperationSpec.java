...
public class UpdateUserContactMethodOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link UpdateUserContactMethodOperationSpec}.
     *
     ...
     * @param contactMethodId      The contact method ID on the user.
     * @param createUserContactMethodRequest The user's contact method to be updated.
     */
    @ApiStatus.Internal
    public UpdateUserContactMethodOperationSpec(String id, String contactMethodId, CreateUserContactMethodRequest createUserContactMethodRequest) {
        this.id = id;
