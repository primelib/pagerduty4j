...
public class UpdateServiceEventRuleOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link UpdateServiceEventRuleOperationSpec}.
     *
     ...
     * @param updateServiceEventRuleRequest 
     */
    @ApiStatus.Internal
    public UpdateServiceEventRuleOperationSpec(String id, String ruleId, UpdateServiceEventRuleRequest updateServiceEventRuleRequest) {
        this.id = id;
        this.ruleId = ruleId;
        this.updateServiceEventRuleRequest = updateServiceEventRuleRequest;
