 ...
 * <p>
 * Specification for the ListIncidentWorkflows operation.
 * <p>
...
public class ListIncidentWorkflowsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListIncidentWorkflowsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListIncidentWorkflowsOperationSpec(Consumer<ListIncidentWorkflowsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListIncidentWorkflowsOperationSpec(Integer limit, Integer offset, Boolean total, String query, String include) {
        this.limit = limit;
        this.offset = offset;
        this.total = total;
        this.query = query;
