...
public class GetIncidentImpactedBusinessServicesOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetIncidentImpactedBusinessServicesOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public GetIncidentImpactedBusinessServicesOperationSpec(String id) {
        this.id = id;
