...
@JsonTypeName("StatusPagePostPostRequest")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class StatusPagePostPostRequest {
    ...
    /**
     * Constructs a validated instance of {@link StatusPagePostPostRequest}.
     *
     * @param spec the specification to process
     */
    public StatusPagePostPostRequest(Consumer<StatusPagePostPostRequest> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link StatusPagePostPostRequest}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #StatusPagePostPostRequest(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public StatusPagePostPostRequest(TypeEnum type, String title, PostTypeEnum postType, OffsetDateTime startsAt, OffsetDateTime endsAt, List<StatusPagePostUpdateRequest> updates, StatusPageImpactStatusPage statusPage) {
        this.type = type;
        this.title = title;
