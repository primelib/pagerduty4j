...
public class VendorReference {
    ...
    /**
     * Constructs a validated instance of {@link VendorReference}.
     *
     ...
     * Constructs a validated instance of {@link VendorReference}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #VendorReference(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public VendorReference(String id, String summary, TypeEnum type, String self, String htmlUrl) {
        this.id = id;
