...
public class RemoveTeamNotificationSubscriptionsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link RemoveTeamNotificationSubscriptionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public RemoveTeamNotificationSubscriptionsOperationSpec(Consumer<RemoveTeamNotificationSubscriptionsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public RemoveTeamNotificationSubscriptionsOperationSpec(String id, CreateTeamNotificationSubscriptionsRequest createTeamNotificationSubscriptionsRequest) {
        this.id = id;
