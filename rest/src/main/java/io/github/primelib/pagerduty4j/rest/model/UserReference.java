...
public class UserReference {
    ...
    /**
     * Constructs a validated instance of {@link UserReference}.
     *
     * @param spec the specification to process
     */
    public UserReference(Consumer<UserReference> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link UserReference}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #UserReference(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public UserReference(String id, String summary, TypeEnum type, String self, String htmlUrl) {
        this.id = id;
