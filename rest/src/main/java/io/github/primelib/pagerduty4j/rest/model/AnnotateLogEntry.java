...
@JsonTypeName("AnnotateLogEntry")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class AnnotateLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link AnnotateLogEntry}.
     *
     * @param spec the specification to process
     */
    public AnnotateLogEntry(Consumer<AnnotateLogEntry> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AnnotateLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AnnotateLogEntry(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public AnnotateLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails) {
        this.id = id;
