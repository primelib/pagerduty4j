...
public class CreateAutomationActionsRunnerTeamAssociationOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link CreateAutomationActionsRunnerTeamAssociationOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public CreateAutomationActionsRunnerTeamAssociationOperationSpec(String id, CreateAutomationActionTeamAssociationRequest createAutomationActionTeamAssociationRequest) {
        this.id = id;
