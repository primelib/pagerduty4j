...
public class DelegateLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link DelegateLogEntry}.
     *
     ...
     * Constructs a validated instance of {@link DelegateLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #DelegateLogEntry(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public DelegateLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails, List<UserReference> assignees) {
        this.id = id;
