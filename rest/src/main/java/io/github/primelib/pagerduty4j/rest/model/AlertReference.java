...
public class AlertReference {
    ...
    /**
     * Constructs a validated instance of {@link AlertReference}.
     *
     * @param spec the specification to process
     */
    public AlertReference(Consumer<AlertReference> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AlertReference}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AlertReference(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public AlertReference(String id, String summary, TypeEnum type, String self, String htmlUrl) {
        this.id = id;
