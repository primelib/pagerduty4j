...
/**
 * DeleteStatusPagePostSpec
 * <p>
 * Specification for the DeleteStatusPagePost operation.
 * <p>
...
public class DeleteStatusPagePostOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link DeleteStatusPagePostOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public DeleteStatusPagePostOperationSpec(Consumer<DeleteStatusPagePostOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public DeleteStatusPagePostOperationSpec(String id, String postId, String X_EARLY_ACCESS) {
        this.id = id;
        this.postId = postId;
