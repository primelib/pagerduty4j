...
public class GetOrchestrationIntegrationOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetOrchestrationIntegrationOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public GetOrchestrationIntegrationOperationSpec(String id, String integrationId) {
        this.id = id;
