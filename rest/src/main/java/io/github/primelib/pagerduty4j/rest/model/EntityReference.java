...
public class EntityReference {
    ...
    /**
     * Constructs a validated instance of {@link EntityReference}.
     *
     * @param spec the specification to process
     */
    public EntityReference(Consumer<EntityReference> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link EntityReference}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #EntityReference(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public EntityReference(String id, String summary, TypeEnum type, String self, String htmlUrl) {
        this.id = id;
