 ...
 * <p>
 * Specification for the ListTeamsAuditRecords operation.
 * <p>
...
public class ListTeamsAuditRecordsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListTeamsAuditRecordsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListTeamsAuditRecordsOperationSpec(Consumer<ListTeamsAuditRecordsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListTeamsAuditRecordsOperationSpec(String id, Integer limit, String cursor, OffsetDateTime since, OffsetDateTime until) {
        this.id = id;
        this.limit = limit;
        this.cursor = cursor;
        this.since = since;
