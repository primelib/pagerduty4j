...
/**
 * CreateStatusPagePostmortemSpec
 * <p>
 * Specification for the CreateStatusPagePostmortem operation.
 * <p>
...
public class CreateStatusPagePostmortemOperationSpec {
    /**
     ...
     */
    @Nullable 
    private CreateStatusPagePostmortemRequest createStatusPagePostmortemRequest;

    /**
     * Constructs a validated instance of {@link CreateStatusPagePostmortemOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateStatusPagePostmortemOperationSpec(Consumer<CreateStatusPagePostmortemOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param createStatusPagePostmortemRequest 
     */
    @ApiStatus.Internal
    public CreateStatusPagePostmortemOperationSpec(String id, String postId, String X_EARLY_ACCESS, CreateStatusPagePostmortemRequest createStatusPagePostmortemRequest) {
        this.id = id;
        this.postId = postId;
        this.X_EARLY_ACCESS = X_EARLY_ACCESS;
        this.createStatusPagePostmortemRequest = createStatusPagePostmortemRequest;
