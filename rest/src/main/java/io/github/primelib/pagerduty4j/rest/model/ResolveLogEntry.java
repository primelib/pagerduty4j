...
@JsonTypeName("ResolveLogEntry")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class ResolveLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link ResolveLogEntry}.
     *
     * @param spec the specification to process
     */
    public ResolveLogEntry(Consumer<ResolveLogEntry> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ResolveLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ResolveLogEntry(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public ResolveLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails) {
        this.id = id;
