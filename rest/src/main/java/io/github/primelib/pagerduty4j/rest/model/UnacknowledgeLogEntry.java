...
@JsonTypeName("UnacknowledgeLogEntry")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class UnacknowledgeLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link UnacknowledgeLogEntry}.
     *
     * @param spec the specification to process
     */
    public UnacknowledgeLogEntry(Consumer<UnacknowledgeLogEntry> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link UnacknowledgeLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #UnacknowledgeLogEntry(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public UnacknowledgeLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails) {
        this.id = id;
