...
/**
 * GetStatusPageSeveritySpec
 * <p>
 * Specification for the GetStatusPageSeverity operation.
 * <p>
...
public class GetStatusPageSeverityOperationSpec {
    /**
    ...
    /**
     * The ID of the Status Page severity.
     */
    @NotNull 
    ...
    /**
     * Constructs a validated instance of {@link GetStatusPageSeverityOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetStatusPageSeverityOperationSpec(Consumer<GetStatusPageSeverityOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param severityId           The ID of the Status Page severity.
     ...
     */
    @ApiStatus.Internal
    public GetStatusPageSeverityOperationSpec(String id, String severityId, String X_EARLY_ACCESS) {
        this.id = id;
    ...
    public void validate() {
        ...
        Objects.requireNonNull(severityId, "severityId is a required parameter!");
