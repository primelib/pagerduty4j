...
@JsonTypeName("AutomationActionsAbstractAction")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class AutomationActionsAbstractAction {
    ...
    /**
     * Constructs a validated instance of {@link AutomationActionsAbstractAction}.
     *
     * @param spec the specification to process
     */
    public AutomationActionsAbstractAction(Consumer<AutomationActionsAbstractAction> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AutomationActionsAbstractAction}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AutomationActionsAbstractAction(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public AutomationActionsAbstractAction(String id, String summary, String type, String self, String htmlUrl, String name, String description, ActionTypeEnum actionType, AutomationActionsActionClassificationEnum actionClassification, String runner, AutomationActionsRunnerTypeEnum runnerType, List<ServiceReference> services, AutomationActionsUserPermissions privileges, Object metadata, OffsetDateTime creationTime, OffsetDateTime modifyTime, OffsetDateTime lastRun, AutomationActionsAbstractActionAllOfLastRunBy lastRunBy) {
        this.id = id;
