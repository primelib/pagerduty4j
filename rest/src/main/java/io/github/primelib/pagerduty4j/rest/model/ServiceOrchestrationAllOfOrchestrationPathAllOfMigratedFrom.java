...
public class ServiceOrchestrationAllOfOrchestrationPathAllOfMigratedFrom {
    ...
    /**
     * Constructs a validated instance of {@link ServiceOrchestrationAllOfOrchestrationPathAllOfMigratedFrom}.
     *
     * @param spec the specification to process
     */
    public ServiceOrchestrationAllOfOrchestrationPathAllOfMigratedFrom(Consumer<ServiceOrchestrationAllOfOrchestrationPathAllOfMigratedFrom> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ServiceOrchestrationAllOfOrchestrationPathAllOfMigratedFrom}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ServiceOrchestrationAllOfOrchestrationPathAllOfMigratedFrom(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public ServiceOrchestrationAllOfOrchestrationPathAllOfMigratedFrom(String id, String type, String self) {
        this.id = id;
        this.type = type;
        this.self = self;
    }
