...
public class AgentReference {
    ...
    /**
     * Constructs a validated instance of {@link AgentReference}.
     *
     * @param spec the specification to process
     */
    public AgentReference(Consumer<AgentReference> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link AgentReference}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AgentReference(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public AgentReference(String id, String summary, TypeEnum type, String self, String htmlUrl) {
        this.id = id;
