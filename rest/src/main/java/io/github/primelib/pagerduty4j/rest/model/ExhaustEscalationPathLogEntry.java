...
@JsonTypeName("ExhaustEscalationPathLogEntry")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class ExhaustEscalationPathLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link ExhaustEscalationPathLogEntry}.
     *
     * @param spec the specification to process
     */
    public ExhaustEscalationPathLogEntry(Consumer<ExhaustEscalationPathLogEntry> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ExhaustEscalationPathLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ExhaustEscalationPathLogEntry(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public ExhaustEscalationPathLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails) {
        this.id = id;
