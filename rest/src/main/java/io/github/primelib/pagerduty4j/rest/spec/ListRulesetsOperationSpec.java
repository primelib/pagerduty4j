 ...
 * ListRulesetsSpec
 * <p>
 * Specification for the ListRulesets operation.
 * <p>
 * List Rulesets
 */
@Getter
...
public class ListRulesetsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListRulesetsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListRulesetsOperationSpec(Consumer<ListRulesetsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListRulesetsOperationSpec(Integer limit, Integer offset, Boolean total) {
        this.limit = limit;
        this.offset = offset;
        this.total = total;
