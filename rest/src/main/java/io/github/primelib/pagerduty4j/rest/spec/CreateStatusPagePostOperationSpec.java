...
/**
 * CreateStatusPagePostSpec
 * <p>
 * Specification for the CreateStatusPagePost operation.
 * <p>
...
public class CreateStatusPagePostOperationSpec {
    /**
     ...
     */
    @Nullable 
    private CreateStatusPagePostRequest createStatusPagePostRequest;

    /**
     * Constructs a validated instance of {@link CreateStatusPagePostOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateStatusPagePostOperationSpec(Consumer<CreateStatusPagePostOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param createStatusPagePostRequest 
     */
    @ApiStatus.Internal
    public CreateStatusPagePostOperationSpec(String id, String X_EARLY_ACCESS, CreateStatusPagePostRequest createStatusPagePostRequest) {
        this.id = id;
        this.X_EARLY_ACCESS = X_EARLY_ACCESS;
        this.createStatusPagePostRequest = createStatusPagePostRequest;
