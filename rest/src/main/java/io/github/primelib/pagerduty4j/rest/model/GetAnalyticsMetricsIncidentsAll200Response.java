...
public class GetAnalyticsMetricsIncidentsAll200Response {
     ...
     */
    @ApiStatus.Internal
    public GetAnalyticsMetricsIncidentsAll200Response(AnalyticsModelFilters filters, String timeZone, OrderEnum order, String orderBy, AggregateUnitEnum aggregateUnit, List<AnalyticsIncidentMetrics> data) {
