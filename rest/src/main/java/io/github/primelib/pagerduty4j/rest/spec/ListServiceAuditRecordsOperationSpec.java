 ...
 * <p>
 * Specification for the ListServiceAuditRecords operation.
 * <p>
...
public class ListServiceAuditRecordsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListServiceAuditRecordsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListServiceAuditRecordsOperationSpec(Consumer<ListServiceAuditRecordsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListServiceAuditRecordsOperationSpec(String id, Integer limit, String cursor, OffsetDateTime since, OffsetDateTime until) {
        this.id = id;
        this.limit = limit;
        this.cursor = cursor;
        this.since = since;
