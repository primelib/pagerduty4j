...
@Slf4j
public class PagerDutyRESTProxySpec {
    /*
    ...
    /**
     * Constructs a validated implementation of {@link PagerDutyRESTProxySpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public PagerDutyRESTProxySpec(Consumer<PagerDutyRESTProxySpec> spec) {
        spec.accept(this);
        validate();
    }
    ...
    /**
     * Creates a new {@link PagerDutyRESTProxySpec} with values taken from the proxy environment variables, if applicable.
     */
    public static PagerDutyRESTProxySpec detect() {
        ...
        for (String p : proxies) {
            try {
                ...
                return new PagerDutyRESTProxySpec(spec -> {
