...
@JsonTypeName("WebhookIncidentAction_allOf_log_entries")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class WebhookIncidentActionAllOfLogEntries {
    ...
    /**
     * Constructs a validated instance of {@link WebhookIncidentActionAllOfLogEntries}.
     *
     * @param spec the specification to process
     */
    public WebhookIncidentActionAllOfLogEntries(Consumer<WebhookIncidentActionAllOfLogEntries> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link WebhookIncidentActionAllOfLogEntries}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #WebhookIncidentActionAllOfLogEntries(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public WebhookIncidentActionAllOfLogEntries(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails, Integer acknowledgementTimeout, List<UserReference> assignees, UserReference user, List<IncidentAction> changedActions) {
        this.id = id;
