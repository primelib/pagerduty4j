...
public class CreateUserNotificationRuleOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link CreateUserNotificationRuleOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateUserNotificationRuleOperationSpec(Consumer<CreateUserNotificationRuleOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param createUserNotificationRuleRequest The notification rule to be created.
     */
    @ApiStatus.Internal
    public CreateUserNotificationRuleOperationSpec(String id, CreateUserNotificationRuleRequest createUserNotificationRuleRequest) {
        this.id = id;
