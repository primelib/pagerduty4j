 ...
 * ListAddonSpec
 * <p>
 * Specification for the ListAddon operation.
 * <p>
...
public class ListAddonOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListAddonOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListAddonOperationSpec(Consumer<ListAddonOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param serviceIds           Filters the results, showing only Add-ons for the given services
     * @param filter               Filters the results, showing only Add-ons of the given type
     */
    @ApiStatus.Internal
    public ListAddonOperationSpec(Integer limit, Integer offset, Boolean total, String include, Set<String> serviceIds, String filter) {
        this.limit = limit;
        this.offset = offset;
        this.total = total;
