 ...
 * ListVendorsSpec
 * <p>
 * Specification for the ListVendors operation.
 * <p>
 * List vendors
 */
@Getter
...
public class ListVendorsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListVendorsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListVendorsOperationSpec(Consumer<ListVendorsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListVendorsOperationSpec(Integer limit, Integer offset, Boolean total) {
        this.limit = limit;
        this.offset = offset;
        this.total = total;
