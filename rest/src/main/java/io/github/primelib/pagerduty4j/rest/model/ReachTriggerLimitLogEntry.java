...
@JsonTypeName("ReachTriggerLimitLogEntry")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class ReachTriggerLimitLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link ReachTriggerLimitLogEntry}.
     *
     * @param spec the specification to process
     */
    public ReachTriggerLimitLogEntry(Consumer<ReachTriggerLimitLogEntry> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ReachTriggerLimitLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ReachTriggerLimitLogEntry(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public ReachTriggerLimitLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails) {
        this.id = id;
