...
public class ListServiceEventRulesOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link ListServiceEventRulesOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListServiceEventRulesOperationSpec(Consumer<ListServiceEventRulesOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListServiceEventRulesOperationSpec(String id, Integer limit, Integer offset, Boolean total, String include) {
        this.id = id;
        this.limit = limit;
        this.offset = offset;
        this.total = total;
