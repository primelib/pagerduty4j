...
public class ListEventOrchestrations200ResponseAllOfOrchestrationsInnerTeam {
    ...
    /**
     * Constructs a validated instance of {@link ListEventOrchestrations200ResponseAllOfOrchestrationsInnerTeam}.
     *
     ...
     * Constructs a validated instance of {@link ListEventOrchestrations200ResponseAllOfOrchestrationsInnerTeam}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ListEventOrchestrations200ResponseAllOfOrchestrationsInnerTeam(Consumer)} instead.
     * @param id id
     * @param type A string that determines the schema of the object
     * @param self The API show URL at which the object is accessible
     */
    @ApiStatus.Internal
    public ListEventOrchestrations200ResponseAllOfOrchestrationsInnerTeam(String id, String type, String self) {
        this.id = id;
        this.type = type;
        this.self = self;
    }
