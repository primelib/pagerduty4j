...
public class UpdateOrchPathGlobalOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link UpdateOrchPathGlobalOperationSpec}.
     *
     ...
     * @param orchestrationGlobal  Update Global Orchestration rules. Omitted rules and rule details are deleted.
     */
    @ApiStatus.Internal
    public UpdateOrchPathGlobalOperationSpec(String id, OrchestrationGlobal orchestrationGlobal) {
        this.id = id;
        this.orchestrationGlobal = orchestrationGlobal;
