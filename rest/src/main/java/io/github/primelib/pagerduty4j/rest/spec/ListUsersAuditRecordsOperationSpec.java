 ...
 * <p>
 * Specification for the ListUsersAuditRecords operation.
 * <p>
...
public class ListUsersAuditRecordsOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListUsersAuditRecordsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListUsersAuditRecordsOperationSpec(Consumer<ListUsersAuditRecordsOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListUsersAuditRecordsOperationSpec(String id, Integer limit, String cursor, OffsetDateTime since, OffsetDateTime until) {
        this.id = id;
        this.limit = limit;
        this.cursor = cursor;
        this.since = since;
