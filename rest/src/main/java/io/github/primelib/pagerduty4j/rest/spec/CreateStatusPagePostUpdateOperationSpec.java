...
/**
 * CreateStatusPagePostUpdateSpec
 * <p>
 * Specification for the CreateStatusPagePostUpdate operation.
 * <p>
...
public class CreateStatusPagePostUpdateOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link CreateStatusPagePostUpdateOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public CreateStatusPagePostUpdateOperationSpec(Consumer<CreateStatusPagePostUpdateOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public CreateStatusPagePostUpdateOperationSpec(String id, String postId, String X_EARLY_ACCESS, CreateStatusPagePostUpdateRequest createStatusPagePostUpdateRequest) {
        this.id = id;
        this.postId = postId;
