...
public class Pagination {
    ...
    /**
     * Constructs a validated instance of {@link Pagination}.
     *
     ...
     * Constructs a validated instance of {@link Pagination}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #Pagination(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public Pagination(Integer offset, Integer limit, Boolean more, Integer total) {
        this.offset = offset;
        this.limit = limit;
        this.more = more;
        this.total = total;
