 ...
 * <p>
 * Specification for the ListBusinessServices operation.
 * <p>
...
public class ListBusinessServicesOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListBusinessServicesOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListBusinessServicesOperationSpec(Consumer<ListBusinessServicesOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListBusinessServicesOperationSpec(Integer limit, Integer offset, Boolean total) {
        this.limit = limit;
        this.offset = offset;
        this.total = total;
