 ...
 * <p>
 * Specification for the ListExtensionSchemas operation.
 * <p>
...
public class ListExtensionSchemasOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListExtensionSchemasOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListExtensionSchemasOperationSpec(Consumer<ListExtensionSchemasOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public ListExtensionSchemasOperationSpec(Integer limit, Integer offset, Boolean total) {
        this.limit = limit;
        this.offset = offset;
        this.total = total;
