...
@JsonTypeName("EscalateLogEntry")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class EscalateLogEntry {
     ...
     */
    public EscalateLogEntry(Consumer<EscalateLogEntry> spec) {
        spec.accept(this);
    }
     ...
     */
    @ApiStatus.Internal
    public EscalateLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails, List<UserReference> assignees) {
        this.id = id;
