 ...
 * GetPostmortemSpec
 * <p>
 * Specification for the GetPostmortem operation.
 * <p>
...
public class GetPostmortemOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link GetPostmortemOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public GetPostmortemOperationSpec(Consumer<GetPostmortemOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public GetPostmortemOperationSpec(String id, String postId, String X_EARLY_ACCESS) {
        this.id = id;
        this.postId = postId;
