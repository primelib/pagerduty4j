...
public class ListWebhookSubscriptionsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link ListWebhookSubscriptionsOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListWebhookSubscriptionsOperationSpec(Consumer<ListWebhookSubscriptionsOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param filterType           The type of resource to filter upon.
     * @param filterId             The id of the resource to filter upon.
     */
    @ApiStatus.Internal
    public ListWebhookSubscriptionsOperationSpec(Integer limit, Integer offset, Boolean total, String filterType, String filterId) {
        this.limit = limit;
        this.offset = offset;
        this.total = total;
