...
public class WebhookSubscriptionFilter {
    ...
    /**
     * Constructs a validated instance of {@link WebhookSubscriptionFilter}.
     *
     ...
     * Constructs a validated instance of {@link WebhookSubscriptionFilter}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #WebhookSubscriptionFilter(Consumer)} instead.
     ...
     */
    @ApiStatus.Internal
    public WebhookSubscriptionFilter(String id, TypeEnum type) {
        this.id = id;
        this.type = type;
    }
