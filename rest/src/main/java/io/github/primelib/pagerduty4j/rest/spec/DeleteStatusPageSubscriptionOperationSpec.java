...
/**
 * DeleteStatusPageSubscriptionSpec
 * <p>
...
public class DeleteStatusPageSubscriptionOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link DeleteStatusPageSubscriptionOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public DeleteStatusPageSubscriptionOperationSpec(Consumer<DeleteStatusPageSubscriptionOperationSpec> spec) {
        spec.accept(this);
     ...
     */
    @ApiStatus.Internal
    public DeleteStatusPageSubscriptionOperationSpec(String id, String subscriptionId, String X_EARLY_ACCESS) {
        this.id = id;
