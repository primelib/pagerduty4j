...
@JsonTypeName("ReachAckLimitLogEntry")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class ReachAckLimitLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link ReachAckLimitLogEntry}.
     *
     * @param spec the specification to process
     */
    public ReachAckLimitLogEntry(Consumer<ReachAckLimitLogEntry> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link ReachAckLimitLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #ReachAckLimitLogEntry(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public ReachAckLimitLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails) {
        this.id = id;
