...
/**
 * ListStatusPagePostUpdatesSpec
 * <p>
 * Specification for the ListStatusPagePostUpdates operation.
 * <p>
...
public class ListStatusPagePostUpdatesOperationSpec {
    /**
    ...
    /**
     * Constructs a validated instance of {@link ListStatusPagePostUpdatesOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public ListStatusPagePostUpdatesOperationSpec(Consumer<ListStatusPagePostUpdatesOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param reviewedStatus       Filter by the reviewed status of the Post Update to retrieve.
     */
    @ApiStatus.Internal
    public ListStatusPagePostUpdatesOperationSpec(String id, String postId, String X_EARLY_ACCESS, String reviewedStatus) {
        this.id = id;
        this.postId = postId;
