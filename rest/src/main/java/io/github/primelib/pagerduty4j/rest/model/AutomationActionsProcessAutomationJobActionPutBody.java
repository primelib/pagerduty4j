...
@JsonTypeName("AutomationActionsProcessAutomationJobActionPutBody")
...
public class AutomationActionsProcessAutomationJobActionPutBody {
    ...
    /**
     * Constructs a validated instance of {@link AutomationActionsProcessAutomationJobActionPutBody}.
     *
     ...
     * Constructs a validated instance of {@link AutomationActionsProcessAutomationJobActionPutBody}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AutomationActionsProcessAutomationJobActionPutBody(Consumer)} instead.
     * @param name var.name
     ...
     */
    @ApiStatus.Internal
    public AutomationActionsProcessAutomationJobActionPutBody(String name, String description, AutomationActionsActionClassificationEnum actionClassification, ActionTypeEnum actionType, String runner, AutomationActionsProcessAutomationJobActionDataReference actionDataReference) {
        this.name = name;
