...
@JsonTypeName("createUser_request_user_allOf_license")
...
public class CreateUserRequestUserAllOfLicense {
    ...
    /**
     * Constructs a validated instance of {@link CreateUserRequestUserAllOfLicense}.
     *
     ...
     * Constructs a validated instance of {@link CreateUserRequestUserAllOfLicense}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #CreateUserRequestUserAllOfLicense(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public CreateUserRequestUserAllOfLicense(String id, String summary, TypeEnum type, String self, String htmlUrl) {
        this.id = id;
