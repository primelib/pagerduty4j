...
/**
 * UpdateStatusPagePostSpec
 * <p>
 * Specification for the UpdateStatusPagePost operation.
 * <p>
...
public class UpdateStatusPagePostOperationSpec {
    /**
     ...
     */
    @Nullable 
    private UpdateStatusPagePostRequest updateStatusPagePostRequest;

    /**
     * Constructs a validated instance of {@link UpdateStatusPagePostOperationSpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public UpdateStatusPagePostOperationSpec(Consumer<UpdateStatusPagePostOperationSpec> spec) {
        spec.accept(this);
     ...
     * @param updateStatusPagePostRequest 
     */
    @ApiStatus.Internal
    public UpdateStatusPagePostOperationSpec(String id, String postId, String X_EARLY_ACCESS, UpdateStatusPagePostRequest updateStatusPagePostRequest) {
        this.id = id;
        this.postId = postId;
        this.X_EARLY_ACCESS = X_EARLY_ACCESS;
        this.updateStatusPagePostRequest = updateStatusPagePostRequest;
