...
public class IntegrationReference {
    ...
    /**
     * Constructs a validated instance of {@link IntegrationReference}.
     *
     ...
     * Constructs a validated instance of {@link IntegrationReference}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #IntegrationReference(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public IntegrationReference(String id, String summary, TypeEnum type, String self, String htmlUrl) {
        this.id = id;
