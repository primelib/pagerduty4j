...
@JsonTypeName("SnoozeLogEntry")
@Generated(value = "io.github.primelib.primecodegen.javafeign.JavaFeignGenerator")
public class SnoozeLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link SnoozeLogEntry}.
     *
     * @param spec the specification to process
     */
    public SnoozeLogEntry(Consumer<SnoozeLogEntry> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link SnoozeLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #SnoozeLogEntry(Consumer)} instead.
     * @param id var.name
     ...
     */
    @ApiStatus.Internal
    public SnoozeLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails, List<IncidentAction> changedActions) {
        this.id = id;
