...
@JsonTypeName("AutomationActionsRunnerRunbookBody")
...
public class AutomationActionsRunnerRunbookBody {
    ...
    /**
     * Constructs a validated instance of {@link AutomationActionsRunnerRunbookBody}.
     *
     ...
     * Constructs a validated instance of {@link AutomationActionsRunnerRunbookBody}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #AutomationActionsRunnerRunbookBody(Consumer)} instead.
     * @param name name
     ...
     */
    @ApiStatus.Internal
    public AutomationActionsRunnerRunbookBody(String name, String description, String runbookBaseUri, String runbookApiKey) {
        this.name = name;
