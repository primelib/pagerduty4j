...
public class UpdateOrchestrationIntegrationOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link UpdateOrchestrationIntegrationOperationSpec}.
     *
     ...
     * @param postOrchestrationIntegrationRequest 
     */
    @ApiStatus.Internal
    public UpdateOrchestrationIntegrationOperationSpec(String id, String integrationId, PostOrchestrationIntegrationRequest postOrchestrationIntegrationRequest) {
        this.id = id;
        this.integrationId = integrationId;
        this.postOrchestrationIntegrationRequest = postOrchestrationIntegrationRequest;
