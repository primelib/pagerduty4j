...
public class ListSchedulesAuditRecordsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link ListSchedulesAuditRecordsOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public ListSchedulesAuditRecordsOperationSpec(String id, Integer limit, String cursor, OffsetDateTime since, OffsetDateTime until) {
        this.id = id;
        this.limit = limit;
        this.cursor = cursor;
        this.since = since;
