...
public class GetPausedIncidentReportCountsOperationSpec {
    ...
    /**
     * Constructs a validated instance of {@link GetPausedIncidentReportCountsOperationSpec}.
     *
     ...
     */
    @ApiStatus.Internal
    public GetPausedIncidentReportCountsOperationSpec(OffsetDateTime since, OffsetDateTime until, String serviceId, String suspendedBy) {
        this.since = since;
        this.until = until;
