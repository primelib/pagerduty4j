...
public class TriggerLogEntry {
    ...
    /**
     * Constructs a validated instance of {@link TriggerLogEntry}.
     *
     * @param spec the specification to process
     */
    public TriggerLogEntry(Consumer<TriggerLogEntry> spec) {
        spec.accept(this);
    }
     ...
     * Constructs a validated instance of {@link TriggerLogEntry}.
     * <p>
     * NOTE: This constructor is not considered stable and may change if the model is updated. Consider using {@link #TriggerLogEntry(Consumer)} instead.
     * @param id id
     ...
     */
    @ApiStatus.Internal
    public TriggerLogEntry(String id, String summary, TypeEnum type, String self, String htmlUrl, OffsetDateTime createdAt, Channel channel, AgentReference agent, String note, List<Context> contexts, ServiceReference service, IncidentReference incident, List<TeamReference> teams, LogEntryAllOfEventDetails eventDetails) {
        this.id = id;
