...
public interface PagerDutyEventsV2AsyncApi {
    ...
    CompletableFuture<CreateChangeEvent202Response> createChangeEvent(@NotNull CreateChangeEventRequest createChangeEventRequest);
    ...
    CompletableFuture<CreateChangeEvent202Response> createV2Event(@NotNull CreateV2EventRequest createV2EventRequest);
