...
@Slf4j
public class PagerDutyEventsV2ProxySpec {
    /*
    ...
    /**
     * Constructs a validated implementation of {@link PagerDutyEventsV2ProxySpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public PagerDutyEventsV2ProxySpec(Consumer<PagerDutyEventsV2ProxySpec> spec) {
        spec.accept(this);
        validate();
    }
    ...
    /**
     * Creates a new {@link PagerDutyEventsV2ProxySpec} with values taken from the proxy environment variables, if applicable.
     */
    public static PagerDutyEventsV2ProxySpec detect() {
        ...
        for (String p : proxies) {
            try {
                ...
                return new PagerDutyEventsV2ProxySpec(spec -> {
