...
public class PagerDutyEventsV2AsyncConsumerApi {
    private final PagerDutyEventsV2AsyncApi api;

    public PagerDutyEventsV2AsyncConsumerApi(PagerDutyEventsV2AsyncApi api) {
        this.api = api;
    }
     ...
     * </ul>
     */
    public CompletableFuture<CreateChangeEvent202Response> createChangeEvent(Consumer<CreateChangeEventOperationSpec> spec) {
     ...
     * </ul>
     */
    public CompletableFuture<CreateChangeEvent202Response> createV2Event(Consumer<CreateV2EventOperationSpec> spec) {
